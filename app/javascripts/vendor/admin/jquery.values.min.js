...
(function($){var V=$.values=function(a,b,c){return $(document.body).values(a,b,c);};$.extend(V,{version:"1.3.3",defaults:{copyToData:false,useSelectValue:false,onlyNest:false,nodeFilter:undefined,setEvents:false,setAllEvent:false,onlyFlat:false,noClone:false,uncheckedValue:undefined,keyAttr:'name',copyToAttr:false,includeCounts:false},isOptions:function(o){if(o!==null&&typeof o=="object"){for(var i in V.defaults)
if(o[i]!==undefined)
return true;}
