module E9Crm
  ...
  module Model
    ...
    # TODO would be nice if contact was overridden to automatically create a new one
    ...
    protected
      ...
      def create_contact_parameters
        fn = self.first_name.presence || self.email.split('@').first
        fn = fn[0...25] if fn.present?

        { :first_name => fn, :last_name => self.last_name }
      end
